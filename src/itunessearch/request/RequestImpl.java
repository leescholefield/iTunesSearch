...
/**
 *  A simple implementation of the {@link Request} interface for making Http itunessearch.request to the iTunes Server.
 *  <p>
 *  The primary responsibility of this class is to generate the actual Url that will be sent to the iTunes Server. It also
 *  has convenience methods for sending a itunessearch.request ( {@link RequestImpl#sendRequest()} ) utilizing the
 ...
 *  for each key are valid for either a lookup or search itunessearch.request, this class does not need to check the Map keys or values
 ...
 *  <p>
 *  A note on the offset: the offset is the number of results iTunes should ignore when making a itunessearch.request. To
...
class RequestImpl implements Request {
    ...
    /**
     * Creates a String url by combining the keys and values used in the Builder with the base url for the itunessearch.request type
    ...
    /**
     * Utility method for sending an http itunessearch.request.
     *
