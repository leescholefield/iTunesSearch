 ...
 * <pre>
 *     {@code
 *     Request itunessearch.request = new LookupBuilder(LookupBuilder.IdTypes.ITUNES, id).entity("song").limit(10).newRequest();
 *     Response response = itunessearch.request.sendRequest();
 *
 *     ResultList<Item> results = new Parser().itunessearch.parse(response);
 *     }
 * </pre>
 ...
 * <pre>
 *     {@code
 *     Request itunessearch.request = new LookupRequest(LookupBuilder.IdTypes.ITUNES, firstId, secondId)
