...
import itunessearch.request.Response;
...
/**
 * Uses Gson to itunessearch.parse a Response into a {@link ResultList}.
 *
 * If you are only interested in results of a specific kind ( {@code itunessearch.model.track.Song} for instance), or you know that the
 * JSON returned by the iTunes server will only contain results of a specific kind, you can use a {@link #parseToModel}
 * method, which will automatically cast the results to the {@code itunessearch.model} class.
 *
 * <pre>
 *     {@code
...
public class Parser {
     ...
     *
     * @param jsonString json string to itunessearch.parse.
    ...
    /**
     * Parses the given JSON string into a {@link ResultList<T>} where T is the {@code itunessearch.model} value.
     *
     * @param jsonString json string to itunessearch.parse.
     * @param type {@link itunessearch.model.Item.ItemType} to search for.
     * @param model Item subclass to cast to.
     * @param <T> itunessearch.model to cast Item instances to.
    ...
    /**
     * Parses the given {@link Response} into a {@link ResultList<T>} where T is the {@code itunessearch.model} value.
     *
     * @param response Response instance.
     * @param type {@link itunessearch.model.Item.ItemType} to search for.
     * @param model Item subclass to cast to.
